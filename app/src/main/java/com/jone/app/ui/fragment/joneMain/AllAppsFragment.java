 ...
 */
public class AllAppsFragment extends JoneBaseFragment {
    ...
    public void onAttach(Activity activity) {
        ...
        ((JoneMainActivity) activity).onSectionAttached(1);
    }

    @Override
    public void onShow() {
        super.onShow();
        ((JoneMainActivity) getActivity()).onSectionAttached(1);
    }
    ...
    private void initViews(){
        ...
        txt_info = Utils.setGridEmptyView(getActivity(), gridView_appList, "加载中...");
